...
/*                                                   +#+                      */
/*   Created: 2020/01/16 18:28:51 by dkrecisz       #+#    #+#                */
/*   Updated: 2020/01/21 21:40:39 by dkrecisz      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void		search_for_fd(t_list *list, int fd)
{
	t_list	*node;
...
t_list		*buf_check(t_list **head, int fd)
{
	t_list	*node_ptr;
	t_list	*new_node;
...
int			read_from_fd(t_list *b_node, char **buf)
{
	ssize_t	r_bytes;
	size_t	nl;
...
int			get_next_line(int fd, char **line)
{
	...
	ret = ((fd < 0) || (!line) || (BUFFER_SIZE == 0)) ? -1 : 42;
